    ...
    <>
      ...
      <header className="w-full  bg-[#f3f3f3]">
        ...
        <div className="relative grid w-[max(100%,327px)] sx:grid-cols-[5fr_3fr_1fr] items-center  h-13.75 grid-cols-[2fr_6fr_1fr]">
          ...
          <div className="flex flex-col gap-0.75 w-fit sx:justify-self-center">
          ...
          <Link
            href={"/cart"}
            className="relative w-11.25 h-11.25 hover:scale-105 active:scale-95 transition-transform cursor-pointer"
          >
            <Image
              src={"/main/Cart.png"}
              width={45}
              ...
              alt="cart button"
            />
            <div className="absolute bg-[#FF7622]  box-border h-6.25 w-6.25 rounded-2xl text-center -top-1 right-0">

...
export default function SectionRestaurantItem({
  ...
  return (
    <article
      key={restaurant.name}
      className="flex justify-center border-b sx:border-0 min-w-[300px] hover:scale-105 transition-[scale_opacity] active:opacity-90 active:scale-95 cursor-pointer border-[#EBEBEB] pb-3.5 not-first:mt-3.5"
    >
      <Image
        ...
        className="w-[60] h-[50px] rounded-[8px] mr-2.5 self-center"
      />
